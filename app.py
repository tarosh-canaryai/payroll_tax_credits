...
DOWNLOAD_URL = 'https://drive.google.com/drive/folders/18WUnbWrmtqb4ul4BXP1JfW17MVCt-hdY?usp=sharing'
...
with col_head2:
    ...
    st.link_button(
        label="⬇️ Download Anonymizer Tool (Zip)",
        url=DOWNLOAD_URL,
        help="Click to download the Anonymizer Tool and Instructions."
    )
